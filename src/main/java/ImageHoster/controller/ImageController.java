...
public class ImageController {
    ...
    public String showImage(@PathVariable("imageId") Integer imageId, @PathVariable(name = "title") String title, Model model) {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        // To get user object value for logged-in user
        User user = (User) session.getAttribute("loggeduser");
        // Fetch image by id
        Image image = imageService.getImage(imageId);
        // Using getUser function of Image class to get the current user
        User uploadedBy = image.getUser();
        ...
        if (user.getId() == uploadedBy.getId())
        {
            model.addAttribute("image", image);
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, HttpSession session, Model model)  {
        ...
        User whoUploaded = image.getUser(); // Using getUser function of Image class to get the current user

        //Comparison to check if the logged-in user's id matches to the id of userId of the user who uploaded the image
        // If true user can delete the image, else the error message.
        if(user.getId() == whoUploaded.getId()) {
