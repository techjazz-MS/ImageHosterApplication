...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
        ...
        // Taking regex help from this link https://mkyong.com/regular-expressions/how-to-validate-password-with-regular-expression/
        // maximum Length added as 100

        String acceptedpattern = "(?=.*\\d)(?=.*[a-zA-Z])(?=.*[^a-zA-Z\\d]).{3,100}";
